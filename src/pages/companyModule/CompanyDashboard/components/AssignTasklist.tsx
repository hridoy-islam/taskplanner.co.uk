...
import { Star, Eye, MessageCircle, MessageSquareText } from 'lucide-react';
import { cn } from '@/lib/utils';
import { toast } from '@/components/ui/use-toast';
import axiosInstance from '@/lib/axios';
import { Avatar, AvatarFallback } from '@/components/ui/avatar';

const AssignTaskList = ({ tasks, onMarkAsImportant, onToggleTaskCompletion }) => {
      ...
      <Table>
        <TableHeader className="bg-taskplanner text-white">
          <TableRow className="border-none">
            <TableHead className="w-[30%] border border-gray-200 text-xs font-bold uppercase tracking-wider text-white">
              Task
            </TableHead>
