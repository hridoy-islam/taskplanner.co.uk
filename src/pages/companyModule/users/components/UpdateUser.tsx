...
// 1. Define Validation Schema (Matches CreateUser)
      ...
      const fetchData = async () => {
        ...
        try {
          ...
          form.reset({
            ...
            role: userData.role || undefined, // 'creator' or 'user'
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="overflow-y-auto max-h-[97vh]">
        <DialogHeader>
          ...
          <DialogDescription>
            Update role, company, or personal details below.
          </DialogDescription>
        </DialogHeader>
