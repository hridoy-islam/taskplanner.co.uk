...
//   { id: 3, name: "Charlie Brown", email: "charlie@example.com", avatar: "https://i.pravatar.cc/150?img=3" },
//   { id: 4, name: "Diana Ross", email: "diana@example.com", avatar: "https://i.pravatar.cc/150?img=4" },
// ]
...
//         id: Date.now(),
//         name: newGroupName,
//         members: initialMembers.filter(member => selectedMembers.includes(member.id)),
//         comments: []
//       }
...
//       setNewComment('')
//       addNotification(`New comment in ${selectedGroup.name}: ${newComment.substring(0, 50)}${newComment.length > 50 ? '...' : ''}`)
//     }
//   }
...
//                   </TableCell>
//                   <TableCell>
//                     <Button variant="outline" onClick={() => setSelectedGroup(group)}>View</Button>
//                   </TableCell>
//                 </TableRow>
//               ))}
//             </TableBody>
...
//                   <div key={member.id} className="flex items-center space-x-2 bg-gray-100 rounded-full pl-1 pr-2 py-1">
//                     <Avatar>
//                       <AvatarImage src={member.avatar} alt={member.name} />
//                       <AvatarFallback>{member.name.charAt(0)}</AvatarFallback>
//                     </Avatar>
...
//                       size="icon"
//                       className="h-6 w-6"
//                       onClick={() => selectedGroup && removeMember(selectedGroup.id, member.id)}
//                     >
//                       <X className="h-4 w-4" />
//                     </Button>
//                   </div>
...
//                       {selectedGroup.members.find(m => m.id === comment.memberId)?.name}
//                     </div>
