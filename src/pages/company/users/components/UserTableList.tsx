...
import { Pencil, UserCheck, UserPlus, Search, Link } from 'lucide-react';
...
export default function CompanyUserTableList() {
  ...
  const fetchData = useCallback(
    async (
      ...
      setIsLoading(true);
      try {
        let endpoint = `/users?page=${page}&limit=${entriesPerPage}&searchTerm=${term}&company=${id}`;
