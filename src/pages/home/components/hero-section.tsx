...
export function HeroSection() {
  ...
  <div className="container relative z-10 flex flex-col items-center justify-center text-center gap-12">
    {/* TEXT CONTENT */}
    <div className="max-w-6xl flex flex-col items-center space-y-8">
      <motion.h1
      ...
      >
        ...
        <Button
          size="lg"
          className="h-12 bg-taskplanner text-white hover:bg-taskplanner"
        >
          Sign up - it&apos;s free!
        </Button>
      </motion.div>
